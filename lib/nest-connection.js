            ...
            if (object && object.message && object.message.length > 0) {
                ...
                if (object) {
                    ...
                    translateProperty(object, 'ambient_motion', null, (ambientMotion, id) => {
                        if (checkDeviceExists(body, id) && this.legacyDeviceMap[id] == 'topaz') {
                            let thisDevice = body.topaz[id];
                            let motionPayload = ambientMotion.data && ambientMotion.data.property && ambientMotion.data.property.value;
                            if (!motionPayload || Object.keys(motionPayload).length === 0) {
                                motionPayload = ambientMotion.data && ambientMotion.data.property;
                            }
